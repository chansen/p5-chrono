...
the given year. In that case, the day is set to the last day of the given year.
...
difference between 2013-Q2-90 and 2013-Q3-91 is zero complete quarters.
    ...
    $delta = $start->delta_quarters($end); # 3
...
difference between 2013-02-28 and 2013-03-26 is zero complete months.
    ...
    $delta = $start->delta_months($end); # 7
...
Returns a copy of this date with the given I<years> added. The day of the 
year of the date is unchanged unless the day does not exist in the resulting 
year. In that case, the day is set to the last day of the resulting year. 
For example, 2012-366 plus one year results in 2013-365; 2011-365 plus one 
year results in 2012-365.

=head2 add_quarters

    $date = $date->add_quarters($quarters);

Returns a copy of this date with the given I<quarters> added. The day of the 
quarter of the date is unchanged unless the day does not exist in the resulting 
quarter. In that case, the day is set to the last day of the resulting quarter. 
For example, 2012-Q4-92 plus one quarter results in 2013-Q1-91; 2013-Q1-91 plus 
one quarter results in 2013-Q2-91.

=head2 add_months

    $date = $date->add_months($months);

Returns a copy of this date with the given I<months> added. The day of the 
month of the date is unchanged unless the day does not exist in the resulting 
month. In that case, the day is set to the last day of the resulting month. 
For example, 2013-01-31 plus one month results in 2013-02-28; 2013-02-28 plus 
one month results in 2013-03-28.

=head2 add_weeks

    $date = $date->add_weeks($weeks);

Returns a copy of this date with the given I<weeks> added.

=head2 add_days

    $date = $date->add_days($days);

Returns a copy of this date with the given I<days> added.

...
Returns an instance of C<Chrono::Date> with the given named parameters 
...
Returns an instance of C<Chrono::Date> with the given positional parameters
...
Returns an instance of C<Chrono::Date> with the given Chronological Julian Day 
Number. The Chronological Julian Day Number is a simple incrementing count of 
days where day 1721426 is 0001-01-01. The day number must be within the 
supported range (0001-01-01 to 9999-12-31), otherwise an exception is raised.

=head2 Chrono::Date->from_rnd

    $date = Chrono::Date->from_rdn($rdn);

Returns an instance of C<Chrono::Date> with the given Rata Die Number. The
Rata Die Number is a simple incrementing count of days where day 1 is 0001-01-01. 
The number must be within the supported range (0001-01-01 to 9999-12-31), otherwise 
...
Returns an instance of C<Chrono::Date> from the given I<string>. The string must be a
complete ISO 8601 date only representation, otherwise an exception is raised.
...
Returns the day of the week (1-7). The value follows the ISO 8601 standard, 
...
quarter has fewer days than the day of quarter for the date, then the result 
...
month has fewer days than the day of month for the date, then the result is 
...
Returns a copy of date with the given I<week> of the year altered.

=head2 with_day_of_year

    $date = $date->with_day_of_year($day);

Returns a copy of date with the given I<day> of the year altered.

=head2 with_day_of_quarter

    $date = $date->with_day_of_quarter($day);

Returns a copy of date with the given I<day> of the quarter altered.

=head2 with_day_of_month

    $date = $date->with_day_of_month($day);

Returns a copy of date with the given I<day> of the month altered.

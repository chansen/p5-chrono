...
The day must bevalid for the week and the week must be valid for the year, 
otherwise an exception is raised.
...
Returns a copy of date with the day of the year set to the last day. The 
optional offset parameter specifies the number of years before (negative) 
...
Returns a copy of date with the day of the quarter set to the last day. The 
optional offset parameter specifies the number of quarters before (negative) 
or after (positive) the date.
...
Returns a copy of date with the day of the month set to the last day. The 
...
will be negative if the other date is before this date.
...
result will be negative if the other date is before this date.

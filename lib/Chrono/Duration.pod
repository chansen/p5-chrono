...
=head1 SYNOPSIS
    ...
    $duration2    = $duration1->plus_days($days);
    $duration2    = $duration1->plus_hours($hours);
    $duration2    = $duration1->plus_minutes($minutes);
    $duration2    = $duration1->plus_seconds($seconds);
    $duration2    = $duration1->plus_milliseconds($milliseconds);
    $duration2    = $duration1->plus_microseconds($microseconds);
    
    $duration3    = $duration1->plus_duration($duration2);
    $duration3    = $duration1->minus_duration($duration2);

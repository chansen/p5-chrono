...
=head1 SYNOPSIS
    ...
    $datetime2    = $datetime1->add_years($years);
    $datetime2    = $datetime1->add_quarters($quarters);
    $datetime2    = $datetime1->add_months($months);
    $datetime2    = $datetime1->add_weeks($weeks);
    $datetime2    = $datetime1->add_days($days);
    $datetime2    = $datetime1->add_hours($hours);
    $datetime2    = $datetime1->add_minutes($minutes);
    $datetime2    = $datetime1->add_seconds($seconds);
    $datetime2    = $datetime1->add_milliseconds($milliseconds);
    $datetime2    = $datetime1->add_microseconds($microseconds);
